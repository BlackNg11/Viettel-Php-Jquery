...
<head>
	...
	<title>Đăng kí cáp quang Viettel cho quán cafe,phòng net</title>
	...
	<main class="main-wifi">
		<section class="wifi-for">
			<ul class="wifi-for-lists">
				...
				<a href="wifi-gia-dinh" class="wifi-for-lists--item">
					<li>Gia Đình</li>
				</a>
						...
						<form action="config/server" method="POST" id="test-form">
							...
							<div class="form-2__contact-form--input-container  focus">
								<select  name="res-info" class="form-2__contact-form--input">
									<option value="NetPlus-Wifi-Net" class="form-2__contact-form--input-1">Gói Net</option>
									<option value="SuperNet-Wifi-Net" class="form-2__contact-form--input-1">SuperNet</option>
								</select>

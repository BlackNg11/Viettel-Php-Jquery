...
<main>
	<section class="navigation-pc">
		<ul class="navigation-pc-lists">
			<a href="#" class="navigation-pc-lists--item active-navigation">
				<li>Trang Chủ</li>
			</a>
			<a href="wifi-cho-ho-gia-dinh.php" class="navigation-pc-lists--item">
				<li>Internet-Truyền Hình</li>
			</a>
			<a href="dich-vu-tra-sau-viettel.php" class="navigation-pc-lists--item ">
				<li>Dịch Vụ Di Động</li>
			</a>
			<a href="404.php" class="navigation-pc-lists--item">
				<li>Mua Sim</li>
			</a>
			<a href="404.php" class="navigation-pc-lists--item">
				<li>Mua Điện Thoại</li>
			</a>
			<a href="404.php" class="navigation-pc-lists--item">
				...
				<div class="form">
					<form action="index.php" method="POST" class="form-ui">
						...
						<div class="form__group">
							...
							<input type="tel" name="sdt" class="form__input" autocomplete="off" placeholder="SĐT"
...
>>>>>>> 03bbdcdbdaca92ada6ecd918207e13e9ece22c3b
						...
						<div class="form__group">
							...
							<input type="text" name="diachi" class="form__input" autocomplete="off" maxlength="80"
								placeholder="Địa Chỉ Liên Lạc" id="contact" required
		...
		<div class="viettel-infomation__deep">
			<div class="viettel-infomation__deep__change viettel-infomation__deep__change--1 active">
				<div class="viettel-infomation__deep--left">
					...
					<p>Môt trong những công ty hàng đầu về công nghệ lớn nhất Việt Nam,là nơi được nhiều khách hàng tin
						tưởng và gửi gắm niền tin lựa chọn dịch vụ wifi và điện thoại</p>
				</div>
				<div class="viettel-infomation__deep--right">
					<img class="viettel-infomation__deep--right-img" src="img/Viettel-cong-ty.jpg"
						alt="Công Ty Viettel">
				</div>
			</div>
			<div class="viettel-infomation__deep__change viettel-infomation__deep__change--2">
				<div class="viettel-infomation__deep--left">
					...
					<p>Chúng tôi hiểu rằng, muốn làm được điều đó thì trước hết phải thấu hiểu khách hàng, phải lắng
						nghe khách hàng.Và vì vậy, khách hàng luôn được khuyến khích nói theo cách mà họ mong muốn và
						bằng tiếng nói của chính mình – “Hãy nói theo cách của bạn”.</p>
				</div>
				<div class="viettel-infomation__deep--right">
			...
			<div class="viettel-infomation__deep__change viettel-infomation__deep__change--3">
				<div class="viettel-infomation__deep--left">
					...
					<p>Phục vụ khách hàng là niềm vinh hạnh của chúng tui,luôn đồng hành cùng khách hàng 24h/ngày và 7
						ngày/tuần</p>
				</div>
				<div class="viettel-infomation__deep--right">
	...
	<section class="wifi-detail">
		<a href="wifi-cho-ho-gia-dinh.php">
			<h1 class="heading-secondary u-margin-bottom-medium">Dịch Vụ Wifi Và Truyền Hình Viettel</h1>
		</a>
		...
		<a href="wifi-cho-ho-gia-dinh.php" class="btn-text-2"><span class="btn-text-2-span">Tìm hiểu thêm
				&rarr;</span></a>
	</section>
	<section class="phone-detail">
		<a href="dich-vu-tra-sau-viettel.php">
			<h1 class="heading-secondary u-margin-bottom-medium">Dịch Vụ Trả Sau Và Trả Trước Viettel</h1>
		</a>
		...
		<a href="dich-vu-tra-sau-viettel.php" class="btn-text-2"><span class="btn-text-2-span">Tìm hiểu thêm
				&rarr;</span></a>
	</section>

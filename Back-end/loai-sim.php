    	...
    	<section class="sim__content">
    		<div class="sim__content__selection" style="margin-left: 0">
                <div class="sim__content__selection--heading">
                    <h1>Sim Thần Tài</h1>
                    <p>Sim Thần Tài hay còn được gọi là Sim Tài Lộc là dòng sim được người dùng sở hữu với mong ước mang lại may mắn, tiền tài.</p>
                    <p>Sim thần tài là dòng sim số đẹp có chứa cụm Thần tài nhỏ (39), Thần tài lớn (79), Thần tài kép nhỏ (3939), Thần tài kép lớn (7979), Thần tài kép (3979/ 7939) ở đuôi sim.</p>
                </div>

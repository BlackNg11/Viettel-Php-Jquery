...
<head>
	...
	<meta name="description" content="Lắp đặt mạng wifi Viettel 2020 cho gia đình trọn gói chỉ từ 210k,hỗ trợ nhanh chóng cho khách hàng ở Kiên Giang">
...
?>
	<main class="main-wifi">
		...
		<section class="wifi-contact">
			<h1 class="heading-secondary wifi-contact--head">Bảng giá dịch vụ wifi Viettel + truyền hình cho gia đình</h1>
				...
				<div class="owl-carousel owl-theme">
					...
					<div class="item card-wifi" >
						...
						<div class="card-wifi-bottom">
							...
							<p class="card-wifi-bottom--text">Dành cho nhà nhiều tầng trên 10 người sử dụng trở lên wifi</p>					
						</div>
						<a href="#" class="btn card-wifi-bottom--btn btn-scroll--1">Đăng Ký</a>
					</div>
				</div>
				...
				<div class="owl-carousel owl-theme">
					...
					<div class="item card-wifi" >
						...
						<div class="card-wifi-bottom">
							...
							<p class="card-wifi-bottom--text">Dành cho nhà nhiều tầng trên 10 người sử dụng trở lên wifi</p>
							<p class="card-wifi-bottom--text card-wifi-bottom--text-margin--bot">Tặng miễn phí 1 gói truyền hình và 1 gói K+</p>					
						</div>
						<a href="#" class="btn card-wifi-bottom--btn btn-scroll--1">Đăng Ký</a>
					</div>
				</div>
					...
					<form action="wifi-cho-ho-gia-dinh.php" method="POST">
						...
						<div class="form-2__contact-form--input-container  focus">
							<select  name="dichvudangky" class="form-2__contact-form--input">
									...
									<option value="Gói Net + TV - Gia Đình" class="form-2__contact-form--input-1">Gói Net + Truyền Hình</option>
									<option value="Gói SuperNet + TV - Gia Đình" class="form-2__contact-form--input-1">Gói SuperNet + Truyền Hình</option>
							</select>
